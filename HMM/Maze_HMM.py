...
#  problem, since the locations of the s are fixed and not part of the state;
...
class Maze:
    ...
    def get_color(self, x , y ): # gets the color of the square
        return self.map[self.index(x, y)]
...
if __name__ == "__main__":
    ...
    print(test_maze1)
    print(test_maze1.get_color(1, 1))
